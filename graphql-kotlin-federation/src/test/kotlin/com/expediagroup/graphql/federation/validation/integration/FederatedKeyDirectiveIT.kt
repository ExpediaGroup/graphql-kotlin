...
import com.expediagroup.graphql.federation.data.integration.key.failure._2.KeyMissingFieldSelectionQuery
import com.expediagroup.graphql.federation.data.integration.key.failure._3.InvalidKeyQuery
import com.expediagroup.graphql.federation.data.integration.key.failure._4.BaseKeyReferencingExternalFieldsQuery
import com.expediagroup.graphql.federation.data.integration.key.failure._6.KeyReferencingListQuery
import com.expediagroup.graphql.federation.data.integration.key.failure._7.KeyReferencingInterfaceQuery
import com.expediagroup.graphql.federation.data.integration.key.failure._8.KeyReferencingUnionQuery
import com.expediagroup.graphql.federation.data.integration.key.failure._9.NestedKeyReferencingScalarQuery
import com.expediagroup.graphql.federation.data.integration.key.success._1.SimpleKeyQuery
import com.expediagroup.graphql.federation.data.integration.key.success._3.KeyWithMultipleFieldsQuery
import com.expediagroup.graphql.federation.data.integration.key.success._5.KeyWithNestedFieldsQuery
...
class FederatedKeyDirectiveIT {
    ...
    fun `verifies valid simple @key directive on a federated type`() {
        assertDoesNotThrow {
            val schema = toFederatedSchema(config = federatedTestConfig("com.expediagroup.graphql.federation.data.integration.key.success._2"))
    ...
    fun `verifies @key directive selecting multiple fields on a federated type`() {
        assertDoesNotThrow {
            val schema = toFederatedSchema(config = federatedTestConfig("com.expediagroup.graphql.federation.data.integration.key.success._4"))
    ...
    fun `verifies @key directive with complex field selection on a federated type`() {
        assertDoesNotThrow {
            val schema = toFederatedSchema(config = federatedTestConfig("com.expediagroup.graphql.federation.data.integration.key.success._6"))
