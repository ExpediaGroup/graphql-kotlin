...
const addSection = function(id, value) {
  id = _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_5__.e.sanitizeText(id, (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_5__.g)());
  if (sections[id] === void 0) {
    sections[id] = value;
    _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_5__.l.debug("Added new section :", id);
  }
};
...
const db = {
  parseDirective,
  getConfig: () => (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_5__.g)().pie,
  addSection,
  getSections,
  cleanupValue,
  clear,
...
let conf = (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_5__.g)();
let width;
const height = 450;
const draw = (txt, id, _version, diagObj) => {
  var _a;
  try {
    conf = (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_5__.g)();
    _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_5__.l.debug("Rendering info diagram\n" + txt);
    const securityLevel = (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_5__.g)().securityLevel;
    let sandboxElement;
    ...
    _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_5__.l.debug("Parsed info diagram");
    ...
    (0,_utils_d622194a_js__WEBPACK_IMPORTED_MODULE_6__.k)(diagram2, height, width, conf.pie.useMaxWidth);
    ...
    let [outerStrokeWidth] = (0,_utils_d622194a_js__WEBPACK_IMPORTED_MODULE_6__.x)(themeVariables.pieOuterStrokeWidth);
    outerStrokeWidth ?? (outerStrokeWidth = 2);
    var color = (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .scaleOrdinal */ .PKp)().range(myGeneratedColors);
    ...
    var pie$1 = (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .pie */ .ve8)().value(function(d) {
      return d.value;
    }).sort(function(a, b) {
      return a.order - b.order;
    });
    var dataReady = pie$1(pieData);
    var arcGenerator = (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .arc */ .Nb1)().innerRadius(0).outerRadius(radius);
    var labelArcGenerator = (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .arc */ .Nb1)().innerRadius(radius * textPosition).outerRadius(radius * textPosition);
    ...
    _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_5__.l.error("Error while rendering info diagram");
    _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_5__.l.error(e);
  }
};
const renderer = {
  draw
