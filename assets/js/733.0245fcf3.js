...
/* harmony export */ });
/* harmony import */ var _mermaidAPI_3ae0f2f0_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(43047);
...
const setC4Type = function(c4TypeParam) {
  let sanitizedText = (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.b)(c4TypeParam, (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.g)());
  c4Type = sanitizedText;
};
const parseDirective = function(statement, context, type) {
  _mermaidAPI_3ae0f2f0_js__WEBPACK_IMPORTED_MODULE_5__.m.parseDirective(this, statement, context, type);
};
...
const setTitle = function(txt) {
  let sanitizedText = (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.b)(txt, (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.g)());
  title = sanitizedText;
};
const c4Db = {
  addPersonOrSystem,
  ...
  parseDirective,
  getConfig: () => (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.g)().c4,
  clear,
  LINETYPE,
  ARROWTYPE,
  PLACEMENT,
...
const drawImage = function(elem, width, height, x, y, link) {
  ...
  imageElem.attr("x", x);
  imageElem.attr("y", y);
  let sanitizedLink = link.startsWith("data:image/png;base64") ? link : (0,_braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_1__/* .sanitizeUrl */ .N)(link);
...
const _drawTextCandidateFunc = function() {
  ...
  function byTspan(content, g, x, y, width, height, textAttrs, conf2) {
    ...
    const lines = content.split(_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.e.lineBreakRegex);
...
const setConf = function(cnf) {
  (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.d)(conf, cnf);
  if (cnf.fontFamily) {
...
function calcC4ShapeTextWH(textType, c4Shape, c4ShapeTextWrap, textConf, textLimitWidth) {
  if (!c4Shape[textType].width) {
    if (c4ShapeTextWrap) {
      c4Shape[textType].text = (0,_utils_d622194a_js__WEBPACK_IMPORTED_MODULE_6__.w)(c4Shape[textType].text, textLimitWidth, textConf);
      c4Shape[textType].textLines = c4Shape[textType].text.split(_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.e.lineBreakRegex).length;
      c4Shape[textType].width = textLimitWidth;
      c4Shape[textType].height = (0,_utils_d622194a_js__WEBPACK_IMPORTED_MODULE_6__.m)(c4Shape[textType].text, textConf);
    } else {
      let lines = c4Shape[textType].text.split(_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.e.lineBreakRegex);
      ...
      for (const line of lines) {
        c4Shape[textType].width = Math.max(
          (0,_utils_d622194a_js__WEBPACK_IMPORTED_MODULE_6__.j)(line, textConf),
          c4Shape[textType].width
        );
        lineHeight = (0,_utils_d622194a_js__WEBPACK_IMPORTED_MODULE_6__.m)(line, textConf);
...
const drawBoundary = function(diagram2, boundary, bounds) {
  ...
  let textLimitWidth = (0,_utils_d622194a_js__WEBPACK_IMPORTED_MODULE_6__.j)(boundary.label.text, boundaryLabelConf);
...
const drawC4ShapeArray = function(currentBounds, diagram2, c4ShapeArray2, c4ShapeKeys) {
  ...
  for (const c4ShapeKey of c4ShapeKeys) {
    ...
    c4Shape.typeC4Shape.width = (0,_utils_d622194a_js__WEBPACK_IMPORTED_MODULE_6__.j)(
...
const drawRels = function(diagram2, rels2, getC4ShapeObj, diagObj) {
  ...
  for (let rel of rels2) {
    ...
    let textLimitWidth = (0,_utils_d622194a_js__WEBPACK_IMPORTED_MODULE_6__.j)(rel.label.text, relConf);
    calcC4ShapeTextWH("label", rel, relTextWrap, relConf, textLimitWidth);
    if (rel.techn && rel.techn.text !== "") {
      textLimitWidth = (0,_utils_d622194a_js__WEBPACK_IMPORTED_MODULE_6__.j)(rel.techn.text, relConf);
      calcC4ShapeTextWH("techn", rel, relTextWrap, relConf, textLimitWidth);
    }
    if (rel.descr && rel.descr.text !== "") {
      textLimitWidth = (0,_utils_d622194a_js__WEBPACK_IMPORTED_MODULE_6__.j)(rel.descr.text, relConf);
...
const draw = function(_text, id, _version, diagObj) {
  conf = (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.g)().c4;
  const securityLevel = (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.g)().securityLevel;
  let sandboxElement;
  ...
  _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(`C:${JSON.stringify(conf, null, 2)}`);
  ...
  _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(`models:`, box);
};
const c4Renderer = {
