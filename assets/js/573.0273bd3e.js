...
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(91619);
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(12281);
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(7201);
...
const tasks = [];
const rawTasks = [];
const getCommonDb = () => _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.c;
const parseDirective = (statement, context, type) => {
  (0,_utils_d622194a_js__WEBPACK_IMPORTED_MODULE_5__.p)(globalThis, statement, context, type);
};
...
const draw = function(text, id, version, diagObj) {
  var _a, _b, _c, _d;
  const conf = (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.g)();
  const LEFT_MARGIN = conf.leftMargin ?? 50;
  (_b = (_a = diagObj.db).clear) == null ? void 0 : _b.call(_a);
  diagObj.parser.parse(text + "\n");
  _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("timeline", diagObj.db);
  ...
  _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("task", tasks2);
  svgDraw.initGraphics(svg);
  const sections2 = diagObj.db.getSections();
  _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("sections", sections2);
  ...
  sections2.forEach(function(section) {
    ...
    _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("sectionHeight before draw", sectionHeight);
    maxSectionHeight = Math.max(maxSectionHeight, sectionHeight + 20);
  });
  let maxEventCount = 0;
  let maxEventLineLength = 0;
  _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("tasks.length", tasks2.length);
  for (const [i, task] of tasks2.entries()) {
    ...
    _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("taskHeight before draw", taskHeight);
  ...
  _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("maxSectionHeight before draw", maxSectionHeight);
  _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("maxTaskHeight before draw", maxTaskHeight);
  if (sections2 && sections2.length > 0) {
    sections2.forEach((section) => {
      ...
      _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("sectionNode", sectionNode);
      const sectionNodeWrapper = svg.append("g");
      const node = svgDraw.drawNode(sectionNodeWrapper, sectionNode, sectionNumber, conf);
      _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("sectionNode output", node);
  ...
  _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("bounds", box);
  if (title) {
  ...
  (0,_utils_d622194a_js__WEBPACK_IMPORTED_MODULE_5__.s)(
    void 0,
    svg,
...
const drawTasks = function(diagram2, tasks2, sectionColor, masterX, masterY, maxTaskHeight, conf, maxEventCount, maxEventLineLength, maxSectionHeight, isWithoutSections) {
  ...
  for (const task of tasks2) {
    ...
    _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("taskNode", taskNode);
    const taskWrapper = diagram2.append("g").attr("class", "taskWrapper");
    const node = svgDraw.drawNode(taskWrapper, taskNode, sectionColor, conf);
    const taskHeight = node.height;
    _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("taskHeight after draw", taskHeight);
...
const drawEvents = function(diagram2, events, sectionColor, masterX, masterY, conf) {
  ...
  for (const event of events) {
    ...
    _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("eventNode", eventNode);
...
const genSections = (options) => {
  ...
  for (let i = 0; i < options.THEME_COLOR_LIMIT; i++) {
    ...
    if ((0,khroma__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z)(options["lineColor" + i])) {
