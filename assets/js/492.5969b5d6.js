...
const db = {
  parseDirective,
  getConfig: () => (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_5__.g)().journey,
  clear,
...
function drawActorLegend(diagram2) {
  const conf2 = (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_5__.g)().journey;
  let yPos = 60;
...
const conf = (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_5__.g)().journey;
...
const draw = function(text, id, version, diagObj) {
  ...
  (0,_utils_d622194a_js__WEBPACK_IMPORTED_MODULE_6__.k)(diagram2, height, width, conf2.useMaxWidth);
