...
const setMessage = (txt) => {
  _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_3__.l.debug("Setting message to: " + txt);
  message = txt;
};
const getMessage = () => {
  return message;
...
const db = {
  ...
  setInfo,
  getInfo,
  clear: _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_3__.y
  // parseError
};
const getStyles = () => ``;
...
const draw = (text, id, version) => {
  try {
    _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_3__.l.debug("Rendering info diagram\n" + text);
    const securityLevel = (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_3__.g)().securityLevel;
    let sandboxElement;
    ...
    _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_3__.l.error("Error while rendering info diagram");
    _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_3__.l.error(e.message);
  }
};
const renderer = {
  draw
