...
/* harmony import */ var _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(70044);
/* harmony import */ var _utils_d622194a_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(81188);
/* harmony import */ var _mermaidAPI_3ae0f2f0_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(43047);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(59373);
...
const parseDirective = function(statement, context, type) {
  _mermaidAPI_3ae0f2f0_js__WEBPACK_IMPORTED_MODULE_7__.m.parseDirective(this, statement, context, type);
};
const clear = function() {
  ...
  lastOrder = 0;
  links = {};
  (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_8__.y)();
};
...
const getStartDate = function(prevTime, dateFormat2, str) {
  ...
  if (mDate.isValid()) {
    ...
    _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_8__.l.debug("Invalid date:" + str);
    _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_8__.l.debug("With date format:" + dateFormat2.trim());
...
const setLink = function(ids, _linkStr) {
  ...
  if ((0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_8__.g)().securityLevel !== "loose") {
    linkStr = (0,_braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_0__/* .sanitizeUrl */ .N)(_linkStr);
  }
...
const setClickFun = function(id, functionName, functionArgs) {
  ...
  if (rawTask !== void 0) {
    pushFun(id, () => {
      _utils_d622194a_js__WEBPACK_IMPORTED_MODULE_9__.u.runFunc(functionName, ...argList);
    });
  }
};
...
const ganttDb = {
  parseDirective,
  getConfig: () => (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_8__.g)().gantt,
  clear,
  setDateFormat,
  getDateFormat,
  ...
  setTodayMarker,
  getTodayMarker,
  setAccTitle: _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_8__.o,
  getAccTitle: _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_8__.p,
  setDiagramTitle: _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_8__.w,
  getDiagramTitle: _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_8__.x,
  setDisplayMode,
  getDisplayMode,
  setAccDescription: _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_8__.v,
  getAccDescription: _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_8__.q,
  addSection,
  getSections,
  getTasks,
  addTask,
...
const setConf = function() {
  _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_8__.l.debug("Something is calling, setConf, remove the call");
};
...
const draw = function(text, id, version, diagObj) {
  const conf = (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_8__.g)().gantt;
  ...
  (0,_utils_d622194a_js__WEBPACK_IMPORTED_MODULE_9__.k)(svg, h, w, conf.useMaxWidth);
  ...
  function drawRects(theArray, theGap, theTopPad, theSidePad, theBarHeight, theColorScale, w2) {
    ...
    const securityLevel2 = (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_8__.g)().securityLevel;
  ...
  function makeGrid(theSidePad, theTopPad, w2, h2) {
    ...
    if (resultTickInterval !== null) {
      ...
      switch (interval) {
        case "minute":
          bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_5__/* .timeMinute.every */ .Z_i.every(every));
          break;
        case "hour":
          bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_5__/* .timeHour.every */ .WQD.every(every));
          break;
        case "day":
          bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_5__/* .timeDay.every */ .rr1.every(every));
          break;
        case "week":
          bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_5__/* .timeWeek.every */ .NGh.every(every));
          break;
        case "month":
          bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_5__/* .timeMonth.every */ .F0B.every(every));
          break;
      }
    }
    ...
    if (diagObj.db.topAxisEnabled() || conf.topAxis) {
      ...
      if (resultTickInterval !== null) {
        ...
        switch (interval) {
          case "minute":
            topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_5__/* .timeMinute.every */ .Z_i.every(every));
            break;
          case "hour":
            topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_5__/* .timeHour.every */ .WQD.every(every));
            break;
          case "day":
            topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_5__/* .timeDay.every */ .rr1.every(every));
            break;
          case "week":
            topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_5__/* .timeWeek.every */ .NGh.every(every));
            break;
          case "month":
            topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_5__/* .timeMonth.every */ .F0B.every(every));
            break;
        }
      }
  ...
  function vertLabels(theGap, theTopPad) {
    ...
    svg.append("g").selectAll("text").data(numOccurances).enter().append(function(d) {
      const rows = d[0].split(_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_8__.e.lineBreakRegex);
