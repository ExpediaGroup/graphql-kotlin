...
/* harmony export */ });
/* harmony import */ var _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(70044);
/* harmony import */ var _utils_d622194a_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(81188);
/* harmony import */ var _mermaidAPI_3ae0f2f0_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(43047);
...
let mainBranchName = (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.g)().gitGraph.mainBranchName;
let mainBranchOrder = (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.g)().gitGraph.mainBranchOrder;
let commits = {};
let head = null;
let branchesConfig = {};
...
let seq = 0;
function getId() {
  return (0,_utils_d622194a_js__WEBPACK_IMPORTED_MODULE_5__.q)({ length: 7 });
}
...
const setOptions = function(rawOptString) {
  _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("options str", rawOptString);
  rawOptString = rawOptString && rawOptString.trim();
  rawOptString = rawOptString || "{}";
  try {
    options = JSON.parse(rawOptString);
  } catch (e) {
    _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.error("error while parsing gitGraph options", e.message);
  }
};
...
const commit = function(msg, id, type, tag) {
  _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Entering commit:", msg, id, type, tag);
  id = _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.e.sanitizeText(id, (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.g)());
  msg = _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.e.sanitizeText(msg, (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.g)());
  tag = _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.e.sanitizeText(tag, (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.g)());
  const commit2 = {
    id: id ? id : seq + "-" + getId(),
    message: msg,
    seq: seq++,
  ...
  _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("in pushCommit " + commit2.id);
};
const branch = function(name, order) {
  name = _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.e.sanitizeText(name, (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.g)());
  if (branches[name] === void 0) {
    branches[name] = head != null ? head.id : null;
    branchesConfig[name] = { name, order: order ? parseInt(order, 10) : null };
    checkout(name);
    _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("in createBranch");
  } else {
    let error = new Error(
...
const merge = function(otherBranch, custom_id, override_type, custom_tag) {
  otherBranch = _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.e.sanitizeText(otherBranch, (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.g)());
  custom_id = _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.e.sanitizeText(custom_id, (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.g)());
  ...
  commits[commit2.id] = commit2;
  branches[curBranch] = commit2.id;
  _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(branches);
  _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("in mergeBranch");
};
const cherryPick = function(sourceId, targetId, tag) {
  _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Entering cherryPick:", sourceId, targetId, tag);
  sourceId = _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.e.sanitizeText(sourceId, (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.g)());
  targetId = _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.e.sanitizeText(targetId, (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.g)());
  tag = _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.e.sanitizeText(tag, (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.g)());
  ...
  if (!targetId || commits[targetId] === void 0) {
    ...
    branches[curBranch] = commit2.id;
    _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(branches);
    _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("in cherryPick");
  }
};
const checkout = function(branch2) {
  branch2 = _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.e.sanitizeText(branch2, (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.g)());
...
function prettyPrintCommitHistory(commitArr) {
  ...
  _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(label.join(" "));
...
const prettyPrint = function() {
  _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(commits);
...
const clear$1 = function() {
  commits = {};
  head = null;
  let mainBranch = (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.g)().gitGraph.mainBranchName;
  let mainBranchOrder2 = (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.g)().gitGraph.mainBranchOrder;
  branches = {};
  ...
  seq = 0;
  (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.y)();
};
...
const getCommitsArray = function() {
  ...
  commitArr.forEach(function(o) {
    _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(o.id);
  });
...
const gitGraphDb = {
  parseDirective,
  getConfig: () => (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.g)().gitGraph,
  setDirection,
  setOptions,
  getOptions,
  commit,
  ...
  getDirection,
  getHead,
  setAccTitle: _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.o,
  getAccTitle: _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.p,
  getAccDescription: _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.q,
  setAccDescription: _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.v,
  setDiagramTitle: _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.w,
  getDiagramTitle: _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.x,
...
const drawCommits = (svg, commits2, modifyGraph) => {
  const gitGraphConfig = (0,_utils_d622194a_js__WEBPACK_IMPORTED_MODULE_5__.t)().gitGraph;
...
const draw = function(txt, id, ver, diagObj) {
  clear();
  const conf = (0,_utils_d622194a_js__WEBPACK_IMPORTED_MODULE_5__.t)();
  const gitGraphConfig = conf.gitGraph;
  _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("in gitgraph renderer", txt + "\n", "id:", id, ver);
  ...
  _utils_d622194a_js__WEBPACK_IMPORTED_MODULE_5__.u.insertTitle(
    diagram2,
    "gitTitleText",
    gitGraphConfig.titleTopMargin,
    diagObj.db.getDiagramTitle()
  );
  (0,_utils_d622194a_js__WEBPACK_IMPORTED_MODULE_5__.v)(
    void 0,
    diagram2,
