...
`@deprecated` - schema directive used to represent deprecated portion of the schema. See
[@Deprecated](https://github.com/ExpediaGroup/graphql-kotlin/wiki/Fields#deprecating-fields) annotation documentation
for more details
