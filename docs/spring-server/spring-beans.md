...
| FederatedGraphQLContextFactory   | Generates the context used for federation. Defaults to basic [GraphQLContext](./spring-graphql-context.md) |
| FederatedTracingInstrumentation  | Apollo Federation tracing instrumentation that can be disabled in the configuration. See [federation tracing](../federated/federation-tracing.md) |
