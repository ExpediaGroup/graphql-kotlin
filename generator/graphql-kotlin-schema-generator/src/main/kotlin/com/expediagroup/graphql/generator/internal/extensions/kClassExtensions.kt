...
internal fun KClass<*>.isAnnotationUnion(fieldAnnotations: List<Annotation>): Boolean = (this.isInstance(Any::class) || this.isInstance(Annotation::class)) && fieldAnnotations.getUnionAnnotation() != null
