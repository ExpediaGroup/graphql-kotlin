...
/**
 * Holds mapping between custom GraphQL scalar type and the corresponding Kotlin type that will be used as a type alias.
 *
 * In order to limit the amount of plugin dependencies, we cannot use client-generator GraphQLScalarTypeAlias directly as it is declared as a
