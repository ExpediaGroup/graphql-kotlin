        ...
        val expected =
            """
                ...
                class ReusedTypesQuery(
                  ...
                  suspend fun execute(requestBuilder: HttpRequestBuilder.() -> Unit = {}):
                      GraphQLResponse<ReusedTypesQuery.Result> = graphQLClient.execute(REUSED_TYPES_QUERY,
                      "ReusedTypesQuery", null, requestBuilder)
        ...
        val expected =
            """
                ...
                class ReusedListTypesQuery(
                  ...
                  suspend fun execute(requestBuilder: HttpRequestBuilder.() -> Unit = {}):
                      GraphQLResponse<ReusedListTypesQuery.Result> = graphQLClient.execute(REUSED_LIST_TYPES_QUERY,
                      "ReusedListTypesQuery", null, requestBuilder)
