---
id: gradle-plugin-usage-client
title: Gradle Plugin Client Usage
...
graphql {
  client {
    ...
    serializer = GraphQLSerializer.KOTLINX
    queryFragmentsFile = file("${project.projectDir}/src/main/resources/fragments.graphql")
    timeout {
        connect = 10_000
        read = 30_000
    }
...
val graphqlGenerateClient by tasks.getting(GraphQLGenerateClientTask::class) {
    ...
    serializer.set(GraphQLSerializer.KOTLINX)
    queryFragmentsFile.from("${project.projectDir}/src/main/resources/fragments.graphql")
